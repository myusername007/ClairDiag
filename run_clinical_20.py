...
CASES = [
    ...
    dict(id=9,  label="IC CLAIRE",        syms=["essoufflement","œdèmes","fatigue"],                 onset="progressif",duration="weeks",  exp_top1=None,        exp_urg="faible", exp_tcs_max="besoin_tests",exp_emrg=False,ok_tests=allowed("Asthme","Anémie","Angor")),
    dict(id=10, label="IC NOCTURNE",      syms=["essoufflement","fatigue","œdèmes"],                 onset=None,        duration=None,     exp_top1=None,        exp_urg="faible", exp_tcs_max="besoin_tests",exp_emrg=False,ok_tests=allowed("Asthme","Angor")),
    dict(id=11, label="RYTHME",           syms=["palpitations","fatigue"],                            onset=None,        duration=None,     exp_top1=None,        exp_urg="faible", exp_tcs_max="besoin_tests",exp_emrg=False,ok_tests=allowed("Hypertension","Anémie","Angor")),
